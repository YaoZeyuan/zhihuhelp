...
export type Type_Max_Item_In_Book = number
...
export type Type_Task_Config = {
  request: {
    ua: typeof Consts.Const_Default_Ua | string
    cookie: typeof Consts.Const_Default_Cookie | string
  }
  tasks: Type_Fetch_Task_Config_Item[]
  generate: {
    title: string
    mode: Type_Generate_Type
    imageQuality: Type_Image_Quilty
    maxItemsPerBook: Type_Max_Item_In_Book
    orderBy: Type_Order_By_Config_List
    outputFormats: Type_Output_Format[]
    comment: string
  }
}
