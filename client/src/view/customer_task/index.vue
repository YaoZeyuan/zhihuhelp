<template>
  <div>
    ...
    <el-card>
      <el-form label-width="100px">
        <el-form-item label="电子书名">
          <el-row>
            <el-col :span="18">
              <el-input v-model="database.taskConfig.bookTitle" :disabled="status.isAutoGenerateTitle"></el-input>
            </el-col>
            <el-col :span="4" :offset="2">
              <el-checkbox v-model="status.isAutoGenerateTitle" label="自动生成书名" border></el-checkbox>
            </el-col>
          </el-row>
        </el-form-item>
    ...
    <el-dialog title="发现新版本" v-model="status.showUpgradeInfo" width="80%" :before-close="handleCloseDialog">
