...
import InfoPage from './template/info_page'
import BasePage from './template/base_page'
...
export default class HtmlRender {
  ...
  static infoPage({ title, desc = '' }: { title: string; desc?: string }): Type_Render_Result {
    return {
      singleEle: <InfoPage title={title} desc={desc}></InfoPage>,
      htmlEle: (
        <BasePage title={title}>
          <InfoPage title={title} desc={desc}></InfoPage>
        </BasePage>
      ),
    }
  }
