...
async function asyncInitZhihuEncrypt() {
  ...
  await webviewEle.executeJavaScript(
    `
    // 原代码
    function rawZhihuEncryptFunc(module, exports, __webpack_require__) {
    'use strict'
    function o(e) {
      return (o =
    ...
    function s(e) {
      if (Symbol.A in Object(e) || '[object Arguments]' === Object.prototype.toString.call(e)) return Array.from(e)
    }
    function t() {
