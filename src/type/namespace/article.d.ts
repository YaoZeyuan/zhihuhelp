declare namespace Article {
  type Record = {
    ...
    excerpt: '本来想写很多东西，但认真想想还是不浪费大家时间了。直接上结论： 如果真的有什么计算机名著可以只看目录的话，09年出版的《高性能网站建设进阶》显然算一本。09年在前端历史上是什么概念？直到09年5月，Chrome都还没有Mac版如果你不是<strong>专业</strong>的前端工程师，…'|string
    ...
    reason: ''|string
    share_text: '出版五年以上的前端书最好就别买了——读《高性能网站建设进阶》 - 来自知乎专栏「知乎助手的日常」，作者: 姚泽源 https://zhuanlan.zhihu.com/p/23141946 （想看更多？下载 @知乎 App：http://weibo.com/p/100404711598 ）'|string
    voting: 0|number
