declare namespace Collection {
  ...
  type AnswerExcerpt = {
    ...
    excerpt: '先说一个本人最喜欢、同时认为也是马丁设置的最精妙的彩蛋：冰火中某两个主要人物间的爱情，实际上是他们祖辈之间一段尚未开始就已结束的爱情的延续。在前传《七王国的骑士》中，男主“高个”邓肯曾邂逅了一位贵族小姐“红寡妇”罗翰妮·维伯，二人之间因为种种因缘际会而发展出了若有若无的情愫，当然这是段没有结果的爱情，主要是因为二人身份相差悬殊（罗翰妮是小贵族领主，邓肯只是个雇佣骑士——尽管他的侍从是未来的国王）…'|string
