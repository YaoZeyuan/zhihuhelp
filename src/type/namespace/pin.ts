  ...
  type RepinRecord = {
    ...
    origin_pin: {
      ...
      author: {
        ...
        is_blocking: false
        name: '知乎机构号团队'
        headline: '我有 30000+ 个小伙伴，超厉害'
        type: 'people'
        user_type: 'people'
        id: 'a6756d2515bb9c23170424b57630a2aa'
        vip_info: {
          is_vip: false
        }
        exposed_medal: {
          ...
          description: '被 10000 个人关注'
          mini_avatar_url: 'https://pic3.zhimg.com/50/v2-f9e90c8b834f8fbaa583c67a03d5edda_b.jpg'
          avatar_url: 'https://pic2.zhimg.com/50/v2-c3f45f384c1b28cb4649090e74dd222b_b.jpg'
        }
      ...
      content: [
        {
          content: '<a class="hash_tag" href="https://www.zhihu.com/pin/special/1140593814099091456">#我和机构号锁了#</a> 官宣：机构号在知乎已经陪伴大家三年啦！在这样一个超有仪式感的日子里，63 家机构号集体撒糖～带着爱意满满的大礼来啦～<br><br>转发这条想法，即有机会成为机构号「团宠」，获得「捧在手心大礼包」！<br><br>幸运的小手赶快猛戳「转发」吧～详情查看下方攻略！'
          fold_type: 'raw'
          own_text: '<a class="hash_tag" href="https://www.zhihu.com/pin/special/1140593814099091456">#我和机构号锁了#</a> 官宣：机构号在知乎已经陪伴大家三年啦！在这样一个超有仪式感的日子里，63 家机构号集体撒糖～带着爱意满满的大礼来啦～<br><br>转发这条想法，即有机会成为机构号「团宠」，获得「捧在手心大礼包」！<br><br>幸运的小手赶快猛戳「转发」吧～详情查看下方攻略！'
          type: 'text'
        },
        {
      ...
      state: 'normal'
      tag_specials: {
        '#我和机构号锁了#': 'https://www.zhihu.com/pin/special/1140593814099091456'
      }
      excerpt_title: '#我和机构号锁了# 官宣：机构号在知乎已…'
    ...
    author: {
      ...
      vip_info: {
        ...
        vip_icon: {
          ...
          url: 'https://pic3.zhimg.com/50/v2-4812630bc27d642f7cafcd6cdeca3d7a_l.png'
        }
      }
      exposed_medal: {
        medal_name: '专业'
    ...
    content: [
      {
        content: '转一记，假如我中奖了的话，我会在转发我这条想法的朋友里抽一个把奖品转给他……'
        fold_type: 'raw'
    ...
    state: 'normal'
    tag_specials: {}
    excerpt_title: '转一记，假如我中奖了的话，我会在转发我…'
    comment_permission: 'all'
    type: 'pin'
    content_html: '<div>转一记，假如我中奖了的话，我会在转发我这条想法的朋友里抽一个把奖品转给他……</div>'
    is_admin_close_repin: false
  }
  // 默认想法
  type DefaultRecord = {
    ...
    comment_permission: 'all'
    type: 'pin'
    content_html: '<div>哈尔滨沙赞基本没人看……这可是假期啊</div><img src="https://pic2.zhimg.com/50/v2-e42ce349576557e5a739d2621d518679_b.jpg" data-rawwidth="4096" data-rawheight="3072" class="origin_image zh-lightbox-thumb" width="4096" data-original="https://pic2.zhimg.com/50/v2-e42ce349576557e5a739d2621d518679_r.jpg">'
    is_admin_close_repin: false
  }
}
