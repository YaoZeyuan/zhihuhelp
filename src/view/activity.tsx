    ...
    for (let activityRecord of activityRecordList) {
        ...
        switch (activityRecord.verb) {
            case MActivity.VERB_ANSWER_VOTE_UP:
                let activity1 = renderAnswerActivity(activityRecord)
                activityList.push(activity1)
                break;
            case MActivity.VERB_MEMBER_VOTEUP_ARTICLE:
                let activity2 = renderArticleActivity(activityRecord)
                activityList.push(activity2)
                break;
            default:
        }
    }
